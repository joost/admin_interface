class AdminScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.directory(File.join(CONTROLLER_PATH, controller_class_path))
      # m.directory(File.join('app/helpers', controller_class_path))
      m.directory(File.join(VIEW_PATH, controller_class_path, controller_file_name))
      ...
      m.template 'view_form_partial.html.erb', File.join(VIEW_PATH, controller_class_path, controller_file_name, "_form.html.erb")
